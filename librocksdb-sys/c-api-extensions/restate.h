...
rocksdb_table_properties_get_user_collected_property_keys(
    ...
    size_t* key_count);
/* Only destroys the owned copy returned by rocksdb_sstfilereader_get_table_properties.
 * Never pass borrowed properties from an event, table filter, or collection. */
